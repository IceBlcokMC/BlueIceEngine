...
declare class Server {
    ...
    /**
     * @brief 获取具有给定名称或别名的PluginCommand。
     *
     * @param name 命令的名称或别名
    ...
    /**
     * @brief 根据给定的通用唯一识别码（UUID）获取玩家信息。
     *
    ...
    /**
     * @brief 重新加载服务器配置、功能、脚本和插件。
     */
    reload(): void;

    /**
     * @brief 仅重新加载服务器的 Minecraft 数据。
     *
     * 这包括所有行为包中的函数和脚本文件。
     */
    reloadData(): void;
    ...
    /**
     * @brief 向拥有“endstone.broadcast.user”权限的每位用户广播指定消息。
     *
     * @param message 消息内容
     */
    ...
    /**
     * @brief 创建一个用于向玩家展示的 boss 栏实例。进度默认为 1.0。
     *
    ...
    /**
     * @brief 创建一个向玩家展示的boss栏实例。进度默认为1.0。
     *
    ...
    /**
     * @brief 为指定的方块类型创建一个新的方块数据实例，所有属性均初始化为默认值。
     *
     * @param type 方块类型
     * @return 新的数据实例
     */
    ...
    /**
     * @brief 为指定的方块类型创建一个新的方块数据实例，除了 `data` 中提供的属性外，所有属性均初始化为默认值。
     *
     * @param type 方块类型
    ...
    /**
     * @brief 用于所有管理消息，例如操作员使用命令时的消息。
     */
    static get BroadcastChannelAdmin(): string;

    /**
     * @brief 用于所有公告消息，比如通知用户有玩家加入。
     */
